...
<form method="post" action="{{ '/karyawan/'.$data->first_name }}" enctype="multipart/">
    @csrf
    @method('put')
    <div class="row mb-3" >
        <h1><u> Edit Data </u></h1>
    ...
    <div class="row mb-3">
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" name='city_state_zip' id="city_state_zip" value="{{ $data->city_state_zip }}">
        </div>
      </div>
      <div class="row mb-3">
        <label for="home_phone" class="col-sm-2 col-form-label">Home Phone</label>
        <div class="col-sm-10">
          <input type="text" class="form-control" name='home_phone' id="home_phone" value="{{ $data->home_phone }}">
        </div>
      </div>
      <div class="row mb-3">
        <label for="cell_phone" class="col-sm-2 col-form-label">Cell Phone</label>
        <div class="col-sm-10">
          <input type="text" class="form-control" name='cell_phone' id="cell_phone" value="{{ $data->cell_phone }}">
        </div>
      </div>
      <div class="row mb-3">
      ...
      <div class="row mb-3">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control" name='applied_position' id="applied_position" value="{{ $data->applied_position }}">
        </div>
      </div>
      <div class="row mb-3">
        <label for="expected_salary" class="col-sm-2 col-form-label">Expected Salary</label>
        <div class="col-sm-10">
          <input type="text" class="form-control" name='expected_salary' id="expected_salary" value="{{ $data->expected_salary }}">
        </div>
      </div>
      @if ($data->photo)
          <div class ="mb-3">
            <img style="max-width:50px;max-height:50px" src="{{ url('photo').'/'.$data->photo }}"/>
      @endif
      <div class="row mb-3">
